...
if __name__ == "__main__":
    ...
    for prunning_threshold in thresholds:
        ...
        for mix in mixing_levels:
            ...
            # Train SVM
            clf_FA = tree.DecisionTreeClassifier(max_depth = 8)#, class_weight={0:1/0.26,1: 1/0.58,2:1/0.11, 3:1/0.02}
            clf_fMRI = tree.DecisionTreeClassifier(max_depth = 8)
            clf_GM = tree.DecisionTreeClassifier(max_depth = 8)
            ...
            metrics_df = pd.DataFrame({
                'Model': "Decision Tree Voting Classifier",
            ...
            metrics_df.to_csv('metrics_decision_tree_voting.csv', index=False)
