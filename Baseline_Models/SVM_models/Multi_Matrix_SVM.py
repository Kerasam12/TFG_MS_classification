    ...
    for kernel in kernels:
        ...
        for prunning_threshold in thresholds:
            ...
            for mix in mixing_levels:
                ...
                mixed_datalist = datalist_mixing(datalist_train, mixing_levels[:mix+1], 500)
                ...
                X_train, y_train = generate_train_test(datalist_multilayer)
                X_test, y_test = generate_train_test(datalist_test1)
