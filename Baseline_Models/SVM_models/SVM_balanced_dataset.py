    ...
    for kernel in kernels:
        ...
        for prunning_threshold in thresholds:
            ...
            for mix in mixing_levels:
                ...
                datalist_multilayer = create_multilayer_ms(mixed_datalist)
                print("datapoints for test ",len(datalist_test), "\n")
                datalist_test1 = create_multilayer_ms(datalist_test)
                

                X_train, y_train= generate_train_test(datalist_multilayer, test_size=0)
                X_test, y_test= generate_train_test(datalist_test1, test_size=0)
