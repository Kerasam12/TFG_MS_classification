...
route_features_train = "/home/samper12/Escritorio/IA carrera/TFG/codi_TFG/graphs/graphs_dict_train_Func/"
route_features_test = "/home/samper12/Escritorio/IA carrera/TFG/codi_TFG/graphs/graphs_dict_test_Func/"   
...
if __name__ == "__main__":
    ...
    graphlist_train = [ (g[1], mstype, edds, name, dataset_name) for g, mstype, edds, name, dataset_name in graphlist_train if g is not None]
    graphlist_test = [ (g[1], mstype, edds, name, dataset_name) for g, mstype, edds, name, dataset_name in graphlist_test if g is not None]

    # 2. Load features from disk
    features_dict_train = open_features_dict("/home/samper12/Escritorio/IA carrera/TFG/codi_TFG/features/featues_dict_train_Func")
    features_dict_test = open_features_dict("/home/samper12/Escritorio/IA carrera/TFG/codi_TFG/features/featues_dict_test_Func")
    ...
    best_model_path = 'best_gcn_model_func.pth'
    trained_model = train_gcn_model(model, train_loader, val_loader, num_epochs=1000, learning_rate = 0.0005, model_path = best_model_path)
    ...
    explain_model(best_trained_model, test_loader, heatmap_name="feature_importance_heatmap_Func.png",)
