...
class GCN_dropout(torch.nn.Module):
    def __init__(self, num_node_features, hidden_channels, num_classes, node_dropout=0.2, edge_dropout=0.2):
        ...
        self.lin1 = torch.nn.Linear(38*hidden_channels, hidden_channels)
