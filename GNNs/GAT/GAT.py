...
if __name__ == "__main__":
    ...
    model = GAT(num_node_features, hidden_channels, num_classes, heads=6, node_dropout=0, edge_dropout=0)
    trained_model = train_gcn_model(model, train_loader, val_loader, num_epochs=1000, learning_rate = 0.000001)
    ...
    # Test the model
    test_acc = test_gcn_model(best_trained_model, test_loader)